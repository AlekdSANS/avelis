...
// @ts-nocheck 
/*
 * This file exports the `MerchandisingCampaignProduct` model and its related types.
 *
...
export type GetMerchandisingCampaignProductAggregateType<T extends MerchandisingCampaignProductAggregateArgs> = {
      [P in keyof T & keyof AggregateMerchandisingCampaignProduct]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMerchandisingCampaignProduct[P]>
    : Prisma.GetScalarType<T[P], AggregateMerchandisingCampaignProduct[P]>
}
...
export type GetMerchandisingCampaignProductGroupByPayload<T extends MerchandisingCampaignProductGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MerchandisingCampaignProductGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MerchandisingCampaignProductGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MerchandisingCampaignProductGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MerchandisingCampaignProductGroupByOutputType[P]>
      }
    >
  >
...
export type MerchandisingCampaignProductCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MerchandisingCampaignProductFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MerchandisingCampaignProductDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MerchandisingCampaignProduct'], meta: { name: 'MerchandisingCampaignProduct' } }
  /**
   ...
   * })
  **/
  count<T extends MerchandisingCampaignProductCountArgs>(
    args?: Prisma.Subset<T, MerchandisingCampaignProductCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MerchandisingCampaignProductCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MerchandisingCampaignProductGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MerchandisingCampaignProductGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMerchandisingCampaignProductGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
