...
// @ts-nocheck 
/*
 * This file exports the `MerchandisingCampaign` model and its related types.
 *
...
export type GetMerchandisingCampaignAggregateType<T extends MerchandisingCampaignAggregateArgs> = {
      [P in keyof T & keyof AggregateMerchandisingCampaign]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMerchandisingCampaign[P]>
    : Prisma.GetScalarType<T[P], AggregateMerchandisingCampaign[P]>
}
...
export type GetMerchandisingCampaignGroupByPayload<T extends MerchandisingCampaignGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MerchandisingCampaignGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MerchandisingCampaignGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MerchandisingCampaignGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MerchandisingCampaignGroupByOutputType[P]>
      }
    >
  >
...
export type MerchandisingCampaignCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MerchandisingCampaignFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MerchandisingCampaignDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MerchandisingCampaign'], meta: { name: 'MerchandisingCampaign' } }
  /**
   ...
   * })
  **/
  count<T extends MerchandisingCampaignCountArgs>(
    args?: Prisma.Subset<T, MerchandisingCampaignCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MerchandisingCampaignCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MerchandisingCampaignGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MerchandisingCampaignGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMerchandisingCampaignGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
