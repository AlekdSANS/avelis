...
// @ts-nocheck 
/*
 * This file exports the `ProductNote` model and its related types.
 *
...
export type GetProductNoteAggregateType<T extends ProductNoteAggregateArgs> = {
      [P in keyof T & keyof AggregateProductNote]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateProductNote[P]>
    : Prisma.GetScalarType<T[P], AggregateProductNote[P]>
}
...
export type GetProductNoteGroupByPayload<T extends ProductNoteGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ProductNoteGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ProductNoteGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ProductNoteGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ProductNoteGroupByOutputType[P]>
      }
    >
  >
...
export type ProductNoteCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ProductNoteFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ProductNoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ProductNote'], meta: { name: 'ProductNote' } }
  /**
   ...
   * })
  **/
  count<T extends ProductNoteCountArgs>(
    args?: Prisma.Subset<T, ProductNoteCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ProductNoteCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ProductNoteGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ProductNoteGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProductNoteGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
