...
import { mapProduct, type ProductRecord } from "../utils/productMapper.js";
...
export async function getFeaturedProducts(query: FeaturedProductsQuery) {
...
export async function getRelatedProducts(productId: string) {
	...
	const collectionIds = source.collections.map(
