...
export const journalArticleUpdateSchema = journalArticleSchema.partial().refine((value) => Object.keys(value).length > 0, "At least one article field is required");
//# sourceMappingURL=growthSchemas.js.map