import { z } from "zod";
import { ADMIN_ORDER_DEFAULT_PAGE_SIZE, ADMIN_ORDER_MAX_PAGE_SIZE, } from "../config/adminOrder.js";
...
function dateBoundary(position) {
    return z
        .string()
        .trim()
        ...
        .transform((value) => new Date(`${value}T${position === "start" ? "00:00:00.000" : "23:59:59.999"}Z`));
}
export const adminOrderListQuerySchema = z
    ...
    minTotal: z.preprocess((value) => typeof value === "string" && value.trim() === ""
        ? Number.NaN
        : value, z.coerce.number().nonnegative().max(99_999_999)).optional(),
    maxTotal: z.preprocess((value) => typeof value === "string" && value.trim() === ""
        ? Number.NaN
        : value, z.coerce.number().nonnegative().max(99_999_999)).optional(),
    sort: z
...
export const adminPaymentStatusUpdateSchema = z
    ...
    .strict();
//# sourceMappingURL=adminOrderSchemas.js.map