...
-- CreateEnum
CREATE TYPE "FragranceNoteType" AS ENUM ('TOP', 'HEART', 'BASE');
...
CREATE TABLE "ProductNote" (
    ...
    "type" "FragranceNoteType" NOT NULL,
    "position" INTEGER NOT NULL DEFAULT 0,

    CONSTRAINT "ProductNote_pkey" PRIMARY KEY ("productId","noteId","type")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_volumeMl_key" ON "ProductVariant"("productId", "volumeMl");
